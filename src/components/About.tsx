...
const About: React.FC = () => {
  return (
    <div className="bg-dark-200 px-8" id="about">
      <Container>
        <div className="py-20">
          <motion.div
          ...
          >
            <div className="p-7 md:py-10 flex flex-col md:flex-row items-center justify-between gap-6 bg-dark-200">
              ...
              <div className="flex-1 text-white">
                <div className="pb-4 border-b border-gray-500">
                  ...
                  <p className="pt-2">
                    Mình thực sự thích code và thử thách bản thân học được nhiều
                    cái mới vào mỗi ngày mới. Mục tiêu hiện tại của mình là trở
